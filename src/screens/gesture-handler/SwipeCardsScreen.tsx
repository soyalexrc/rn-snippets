...
const cards = [
    {source: require("../../../assets/images/cards/death.png")},
    {source: require("../../../assets/images/cards/chariot.png")},
    {source: require("../../../assets/images/cards/high-priestess.png")},
    {source: require("../../../assets/images/cards/justice.png")},
    {source: require("../../../assets/images/cards/lover.png")},
    {source: require("../../../assets/images/cards/pendu.png")},
    {source: require("../../../assets/images/cards/tower.png")},
    {source: require("../../../assets/images/cards/strength.png")},
];
...
const Card = ({ card: { source }, shuffleBack, index }: CardProps) => {
    ...
    return (
        <View style={cardStyles.container} pointerEvents="box-none">
...
interface SwipeCardsScreenProps extends AppStackScreenProps<"SwipeCards"> {
}

export const SwipeCardsScreen: FC<SwipeCardsScreenProps> = observer(function SwipeCardsScreen(_props) {
